...
public class LunarDataTest extends TestCase {
  ...
  public void testGetTermIdx() {
    assertEquals(0, data.getTermIdx(2013, 1, 5));
    assertEquals(1, data.getTermIdx(2013, 1, 20));
    assertEquals(22, data.getTermIdx(2013, 12, 7));
    assertEquals(23, data.getTermIdx(2013, 12, 22));
    assertEquals(-1, data.getTermIdx(2013, 2, 14));
  }
